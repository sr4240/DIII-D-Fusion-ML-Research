...
2. Run the script: python BiLSTM_Overlayed_Isolated_Shot_Visual_Analysis.py
3. The script will generate visualization files showing both BiLSTM predictions and kNN cloud classification
...
def create_overlayed_visualization(shot_data):
    ...
    fig.suptitle(f'Plasma State Classification Analysis for Shot {SHOT_NUMBER}',
    ...
    ax4.set_title('(d) Distance from Training Data Cloud', fontsize=18, fontweight='bold')
    ...
    plt.subplots_adjust(hspace=0.3, bottom=0.06, top=0.96)
