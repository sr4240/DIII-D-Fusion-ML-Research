"""
ALL Shots Isolated Shot Visualization Script with BiLSTM Classification

This script iterates through ALL unique shot numbers in the dataset and generates BiLSTM predictions
...
HOW TO USE:
1. Run the script: python ALL_BiLSTM_Overlayed_Isolated_Shot_Visual_Analysis.py
2. The script will automatically process all unique shots in the dataset
...
def main():
    """Main function to run the complete analysis for ALL shots"""
    print("="*70)
    print("Starting BiLSTM Overlayed Analysis for ALL SHOTS")
    print("="*70)
    ...
    unique_shots = sorted(df_cleaned['shot'].unique())
    total_shots = len(unique_shots)

    print(f"\nFound {total_shots} unique shots to process")
